...
export default function ClientLandingPage() {
  ...
  const [selectedService, setSelectedService] = useState("Primeira Consulta do Rec\u00e9m-Nascido (Puericultura)");
  ...
  const hours = "Segunda a Sexta das 08:30 às 17:00";
...
${notes ? `*Observações:* ${notes}` : ""}`;
  ...
  const services = [["Puericultura do 1º Ano de Vida", "Consultas mensais para avaliar ganho de peso, amamentação, sono e desenvolvimento motor.", "Acompanhamento"], ["Consultoria de Introdução Alimentar", "Guia prático para iniciar sólidos a partir dos 6 meses sem traumas e com segurança.", "Nutrologia"], ["Manejo de Alergias & Digestão (APLV)", "Diagnóstico atencioso de alergia ao leite de vaca, refluxo infantil e cólicas.", "Digestão"], ["Consulta Pré-Natal com o Pediatra", "Preparação dos futuros pais no 3º trimestre para o nascimento e os primeiros cuidados.", "Prevenção"]];
  const features = [["Smile", "Puericultura Mês a Mês", "Acompanhamento detalhado do crescimento, marcos motores e imunização do bebê."], ["Apple", "Nutrologia & Alimentação", "Estratégias gentis para vencer a seletividade e ensinar a criança a amar comida de verdade."], ["HeartHandshake", "Acolhimento da Andressa", "Nossa secretária Andressa acolhe os pais com todo o carinho e suporte no agendamento."]];
  const testimonials = [["Marcela Rodrigues", "A melhor pediatra que meu filho poderia ter! A Dra. Juliana sempre acolhe o Ethan com muito amor, acompanha cada detalhe do desenvolvimento dele e esclarece todas as nossas dúvidas com paciência. Confio 100%!", 5], ["Ana Paula Cordeiro", "Foi a minha primeira experiência e amei! Muito carinhosa com minha bebê, muito paciente pra explicar as medicações! Foram quase uma hora de atendimento sem pressa alguma! Dra. Juliana é maravilhosa💗", 5], ["Giselle Vaz", "Só tenho que agradecer a Dra. Juliana Linhares, que nos recebeu com muito carinho e profissionalismo. Nos sentimos acolhidos de forma humana e com toda a segurança necessária!", 5]];
  const stats = [["79 ★", "Avaliações 5,0 no Google"], ["Sala 112", "Edifício Cosmopolitan"], ["1 Hora", "Dedicada por Consulta"]];
  const faq = [["Qual a duração da consulta?", "Nossas consultas duram cerca de 1 hora, garantindo que a criança seja examinada com tranquilidade e todos os pontos da rotina sejam alinhados."], ["Quando fazer a primeira consulta do recém-nascido?", "O ideal é realizar entre o 7º e o 10º dia de vida para conferir ganho de peso e apoiar a amamentação."], ["Onde fica o consultório?", "No Edifício Comercial Cosmopolitan — R. Pref. Sebastião Teixeira, 354, Sala 112, Várzea, Teresópolis."]];
  const simulatorOptions = ["Primeira Consulta do Recém-Nascido (Puericultura)", "Acompanhamento de Introdução Alimentar (6m+)", "Consulta de Rotina / Check-up Pediátrico", "Investigação de Alergia / Refluxo / Dores"];
  const reassuranceItems = [["Consultas de Quase 1 Hora", "Tempo de sobra para examinar a criança sem estresse e tirar dúvidas dos pais."], ["Nutrologia Infantil", "Orientação segura para introdução alimentar, BLW, refluxo e APLV."], ["Ambiente Lúdico", "Sala preparada para acolher bebês e pequenos com leveza e alegria."]];
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <a href="#" className="flex items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-800 border border-emerald-300/80 shadow-md">
              {renderIcon("HeartHandshake")}
            </div>
            <div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 rounded-full border border-border bg-secondary px-4 py-1.5 text-xs font-semibold text-foreground">
                ...
                ⭐ 5,0 com 79 Avaliações · Consultas Humanizadas de 1h · Ed. Cosmopolitan
              </div>

              <h1 className="mt-6 text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                Cuidado médico com afeto, ciência e tempo dedicado <span className="text-accent underline decoration-accent/30 underline-offset-8">para o desenvolvimento do seu filho.</span>
              </h1>

              <p className="mt-6 text-lg leading-relaxed text-muted-foreground sm:text-xl">
                Consultas pediátricas longas e acolhedoras, puericultura do recém-nascido e orientação especializada em introdução alimentar e seletividade infantil.
              </p>
              ...
              <div className="mt-8 flex items-center gap-4 border-t border-border pt-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">79 avaliações unânimes de mães e pais satisfeitos</p>
                </div>
              </div>
            </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl">
                <div className="flex items-center justify-between border-b border-border pb-5">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-100 text-emerald-800 border border-emerald-300/80">
                      {renderIcon("HeartHandshake")}
                    </div>
                    <div>
                      ...
                      <span className="block text-xs text-muted-foreground">
                        Atendimento acolhedor com a Andressa
                      </span>
                    </div>
                  </div>
      ...
      <section id="servicos" className="border-t border-border bg-secondary/50 py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
              Serviços Pediátricos de Excelência
            </p>
            <p className="mt-4 text-base text-slate-600">
              Acompanhamento completo da gestação aos primeiros anos de vida
            </p>
          </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              <div className="relative rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-slate-100 p-10 text-center">
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-emerald-100 text-emerald-800 border border-emerald-300/80 shadow-xl">
                  {renderIcon("HeartHandshake")}
                </div>
                <h4 className="mt-5 text-2xl font-bold text-foreground">Dra. Juliana Linhares</h4>
                <p className="mt-1 text-xs font-semibold tracking-wider text-muted-foreground uppercase">
                  Pediatria & Nutrologia Pediátrica · Ed. Cosmopolitan
                </p>
            ...
            <div className="lg:col-span-6">
              ...
              <p className="mt-2 text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
                Consultório Encantador no Cosmopolitan
              </p>
              <p className="mt-6 text-base leading-relaxed text-muted-foreground">
                A Sala 112 do Edifício Cosmopolitan foi especialmente decorada para que os bebês e crianças se sintam acolhidos, transformando a ida ao pediatra em um momento prazeroso.
              </p>
              <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                Com 79 avaliações 5 estrelas, a Dra. Juliana é admirada em Teresópolis pelo amor genuíno que demonstra em cada atendimento e pela paciência em escutar as angústias dos pais.
              </p>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl sm:p-12">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-3xl font-extrabold text-foreground sm:text-4xl">
                Agende com a Andressa pelo WhatsApp
              </h2>
              <p className="mt-2 text-base text-muted-foreground">
                Preencha os dados do seu filho(a) para garantir seu horário:
              </p>
            </div>
      ...
      <footer className="border-t border-slate-200 bg-white py-12 text-slate-600">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-100 text-emerald-800 border border-emerald-300/80">
                  {renderIcon("HeartHandshake")}
                </div>
                <span className="text-lg font-bold text-slate-900">Dra. Juliana Linhares</span>
              </div>
              <p className="mt-3 text-xs leading-relaxed text-muted-foreground">
                Pediatria afetiva, consultas de 1 hora, puericultura e introdução alimentar com a Dra. Juliana e a recepcionista Andressa no Edifício Cosmopolitan.
              </p>
            </div>
          ...
          <div className="mt-12 border-t border-border pt-6 text-center text-xs text-muted-foreground">
            © {new Date().getFullYear()} Dra. Juliana Linhares · Todos os direitos reservados · Desenvolvimento e Performance por Cronos Agency
          </div>
        </div>
      </footer>
