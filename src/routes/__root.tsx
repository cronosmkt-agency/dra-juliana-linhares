...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dra. Juliana Linhares — Pediatria & Nutrologia Pediátrica | Ed. Cosmopolitan" },
      { name: "description", content: "Pediatria afetiva, consultas de 1 hora, puericultura e introdução alimentar com a Dra. Juliana e a recepcionista Andressa no Edifício Cosmopolitan." },
      { property: "og:title", content: "Dra. Juliana Linhares — Pediatra & Nutróloga" },
      { property: "og:description", content: "Cuidado médico com afeto, tempo e ciência para o desenvolvimento pleno do seu filho." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='#059669'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='white' font-family='sans-serif' font-weight='800' font-size='40'>JL</text></svg>" },
